            ...
            <div className='py-5'>
                <div className="container flex justify-between items-center">
                    ...
                    <div className='flex items-center gap-4'>
                        <a href="#" className="text-primary ml-2 hover:text-brandBlue dark:text-bgcolor dark:hover:text-brandlightcyan font-semibold tracking-widest text-2xl uppercase sm:text-3xl duration-200">
                            Perfume
                        </a>
                        {/* Menu Items */}
                        <div className='hidden lg:block'>
                            <ul className='flex items-center gap-4'>
                                ...
                                <li className='relative cursor-pointer group'>
                                    <a href='#' className='flex items-center gap-[2px] font-semibold hover:text-brandBlue text-primary dark:text-brandWhite dark:hover:text-brandlightcyan duration-200 py-2'>
                                        Quick Links
                                        <span>
                                    ...
                                    <div className='absolute z-[9999] hidden group-hover:block w-[200px] bg-bgcolor rounded-md text-primary bg-shadow-md dark:bg-glassblue p-2'>
                                        <ul className='space-y-2'>
                                            {DropdownLinks.map((data) => (
                                                <li key={data.id}>
                                                    <a className='text-primary hover:text-brandBlue dark:text-brandWhite dark:hover:text-brandlightcyan duration-200 p-2 font-semibold' href={data.link}>
                                                        {data.name}
                                                    </a>
                                                </li>
                                            ))}
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div className="relative group hidden sm:block">
                            <input type="text" placeholder="Search" className="search-bar text-primary" />
                            <IoSearchSharp className="text-2xl text-primary group-hover:text-primary dark:text-brandWhite absolute top-1/2 -translate-y-1/2 right-3 duration-200" />
                        </div>
