                ...
                <div className='grid grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 lg:gap-6 gap-2 m-2'>
                    ...
                    >
                        <div>
                            ...
                            <p className='text-4xl lg:text-5xl sm:text-[20px] font-bold opacity-40 mb-2'>Floral</p>
                        </div>
                    ...
                    <div
                        className='bg-gradient-to-br from-primarycat/90 to-primary/90 dark:from-[#140F07] dark:via-[#3B2F2F] dark:to-[#1B1A17] text-brandWhite rounded-3xl h-[320px] flex flex-col justify-between p-5 relative'
                    >
                        <div>
                            <p className='text-xl mb-[2px] text-brandBlue'>Indulge </p>
                            <p className='text-3xl font-semibold mb-[2px]'>With </p>
                            <p className='text-4xl xl:text-5xl font-bold opacity-40 mb-2'>Woody</p>
                        </div>
                        <div className='mt-3 lg:mt-3'>
                            <Button
                                text="Browse"
                    ...
                    >
                        <div>
                            <p className='text-xl mb-[2px] text-heading'>Indulge </p>
                            <p className='text-3xl font-semibold mb-[2px]'>With </p>
                            <p className='text-4xl xl:text-5xl font-bold opacity-40 mb-2'>Musk</p>
                        </div>
                        <div className='mt-3 lg:mt-3'>
                            <Button
                                text="Browse"
