        ...
        <div className='py-8'>
            <div className='container mx-auto'>
                <div className='grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6 gap-2 m-2'>
                    ...
                    <div className='bg-gradient-to-br from-primarycat/90 to-primary/90 dark:from-[#140F07] dark:via-[#3B2F2F] dark:to-[#1B1A17] text-brandWhite rounded-3xl h-[320px] flex flex-col justify-between p-5 relative'>
                        <div>
                    ...
                    <div className='bg-gradient-to-br from-primarycat/90 to-primary/90 dark:from-[#140F07] dark:via-[#3B2F2F] dark:to-[#1B1A17] text-brandWhite rounded-3xl h-[320px] flex flex-col justify-between p-5 relative col-span-2'>
                        <div>
                            <p className='text-xl mb-[2px] text-brandBlue'>Indulge </p>
                            <p className='text-3xl font-semibold mb-[2px]'>With </p>
